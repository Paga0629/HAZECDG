...
def main() -> None:
    parser = argparse.ArgumentParser(
        description=(
            "LHD baseline / HazeCDG counter-degradation guidance with sparse causal degradation reuse."
        )
    )
    parser.add_argument(
        "--config",
    ...
    if args.check_only:
        ...
        if runtime_cfg.mode == "hazecdg":
            ...
            print("[check] non-anchor   : latest sensed haze differential is reused causally")
